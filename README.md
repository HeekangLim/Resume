...
모바일 앱 개발자 임희강의 포트폴리오 웹사이트입니다.
Android(Kotlin · Jetpack Compose)와 Flutter 크로스플랫폼을 중심으로,
잡코리아 등 현재 서비스부터 피처폰·IPTV 시기의 초기 모바일 프로젝트까지 정리했습니다.

## 구성

- `index.html` — 포트폴리오 메인 화면 (소개 · 기술 · 경력 · 프로젝트 · 교육/자격 · 연락처)
- `career.html` — 회사·프로젝트별 상세 경력기술서 (인쇄 및 PDF 저장 지원)

## 보기

`index.html` 파일을 더블클릭해 브라우저에서 바로 열면 됩니다.
메인 화면의 **경력기술서 보기**를 누르면 상세 문서로 이동합니다.
